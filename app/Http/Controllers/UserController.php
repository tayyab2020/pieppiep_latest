...
class UserController extends Controller
{
    ...
    public function CustomerQuotations(Request $request, $id = '')
    {
            $user_id = '';
            $user_role = '';
        if(Auth::check()){
