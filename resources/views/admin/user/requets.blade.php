                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <div class="add-product-box">
                                      <div class="add-product-header products">
                                          <h2>Retailer Update Requests</h2>
    ...
    <table id="example" class="table table-striped table-hover products dt-responsive dataTable no-footer dtr-inline" role="grid" aria-describedby="product-table_wrapper_info" style="width: 100%;margin-top: 55px !important;" width="100%" cellspacing="0">
                                              <thead>
                                                  <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="product-table_wrapper" rowspan="1" colspan="1" style="width: 134px;" aria-label="Blood Group: activate to sort column ascending" id="rate">Company Profile</th>
                                              ...
                                              <tr role="row" class="odd">
                                                      ...
                                                      <td>{{$key->company_profile ? 'Yes' : 'No'}}

                                                      <td>{{$key->Date}}</td>

                                                      <td>{{$key->UpdateDate}}</td>

                                                      <td><a href="{{ asset('logstof/request/' . $key->id ) }}">View</a></td>
