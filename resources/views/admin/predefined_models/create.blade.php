                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    ...
                                    <div class="add-product-header">
                                        <h2>{{isset($model) ? __('text.Edit Model') : __('text.Add Model')}}</h2>
                                    ...
                                    <form class="form-horizontal" action="{{route('predefined-model-store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="accordion-menu">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="accordion-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input value="{{isset($model) ? $model->model : null}}" class="form-control" name="title" id="blood_group_display_name" placeholder="{{__('text.Model Title Placeholder')}}" required="" type="text">
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label col-sm-4" for="blood_group_slug">{{__("text.Model Category")}}*</label>
                                                ...
                                                <li>
                                                    <input type="checkbox">
                                                    <h2>{{__("text.Sizes")}} <i class="arrow"></i></h2>
                                                    <div class="accordion-content">
                                                        ...
                                                        <div class="table options-table">
                                                            ...
                                                            <table style="margin: auto;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 10%;">{{__("text.Measure")}}</th>
                                                                    ...
                                                                    @foreach($models_data as $f1 => $key1)
                                                                        ...
                                                                        <tr data-id="{{$f1+1}}">
                                                                            <td>
                                                                                ...
                                                                                <input value="{{$key1->model}}" class="form-control size_title" name="sizes[]" id="blood_group_slug" placeholder="{{__('text.Size Title Placeholder')}}" type="text">
                                                                            </td>
                                                                            <td>
                                                                                <input value="{{str_replace(".",",",$key1->value)}}" maskedformat="9,1" class="form-control size_value" name="size_values[]" id="blood_group_slug" placeholder="{{__('text.Value Placeholder')}}" type="text">
                                                                            </td>
                                                                            <td>
                                                                                <input value="{{str_replace(".",",",$key1->factor_value)}}" maskedformat="9,1" class="form-control size_factor_value" name="size_factor_values[]" id="blood_group_slug" placeholder="{{__('text.Factor Value Placeholder')}}" type="text">
                                                                            </td>
                                                                            <td>
                                                                                <select class="form-control" name="size_measure[]">
                                                                                    ...
                                                                                    <option {{$key1->measure == 'Custom Sized' ? 'selected' : null}} value="Custom Sized">{{__("text.Custom Sized")}}</option>
                                                                                    <option {{$key1->measure == 'Per Piece' ? 'selected' : null}} value="Per Piece">{{__("text.Per Piece")}}</option>
                                                                            ...
                                                                            <td>
                                                                                <select class="form-control" name="price_impact[]">
                                                                                    ...
                                                                                    <option {{$key1->m1_impact == 1 ? 'selected' : null}} value="2">{{__("text.m¹ Impact")}}</option>
                                                                ...
                                                                @else
                                                                    ...
                                                                    <tr data-id="1">
                                                                        <td>
                                                                            ...
                                                                            <input class="form-control size_title" name="sizes[]" id="blood_group_slug" placeholder="{{__('text.Size Title Placeholder')}}" type="text">
                                                                        </td>
                                                                        <td>
                                                                            <input maskedformat="9,1" class="form-control size_value" name="size_values[]" id="blood_group_slug" placeholder="{{__('text.Value Placeholder')}}" type="text">
                                                                        </td>
                                                                        <td>
                                                                            <input maskedformat="9,1" class="form-control size_factor_value" name="size_factor_values[]" id="blood_group_slug" placeholder="{{__('text.Factor Value Placeholder')}}" type="text">
                                                                        </td>
                                                                        <td>
                                                                            <select class="form-control" name="size_measure[]">
                                                                                ...
                                                                                <option value="Custom Sized">{{__("text.Custom Sized")}}</option>
                                                                                <option value="Per Piece">{{__("text.Per Piece")}}</option>
                                        ...
                                        <div style="margin-top: 20px;" class="add-product-footer">
                                            <button name="addProduct_btn" type="submit" class="btn add-product_btn">{{isset($model) ? __('text.Edit Model') : __('text.Add Model')}}</button>
                                        </div>
