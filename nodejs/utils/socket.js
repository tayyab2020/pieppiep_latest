        ...
        this.io.on('connection', (socket) => {
            ...
            */
            socket.on('getMessages', async (data) => {
				...
				if (result != null && !result.data.length) {
                    ...
                    this.io.to(socket.id).emit('getMessagesResponse', {result:result.data,toUserId:data.toUserId});
				}
            });
            ...
            */
            ...
            socket.on('upload-image', async (response) => {
                ...
                var writer = fs.createWriteStream(path.resolve(__basedir) + "/" + "uploads/media/" + filepath, { encoding: 'base64'});
