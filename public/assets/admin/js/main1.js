...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function renderInnerContent$2(innerProps) {
        var title = "";
        if(innerProps.event.extendedProps.quotation_id)
        {
            if(innerProps.event.extendedProps.client_quotation_fname || innerProps.event.extendedProps.client_quotation_lname)
            {
                title = innerProps.event.extendedProps.client_quotation_fname + ' ' + innerProps.event.extendedProps.client_quotation_lname;
            }
        }
        else if(innerProps.event.extendedProps.retailer_client_id)
        {
            title = innerProps.event.extendedProps.client_fname + ' ' + innerProps.event.extendedProps.client_lname;
        }
        else if(innerProps.event.extendedProps.supplier_id)
        {
            title = innerProps.event.extendedProps.company_name;
        }
        else
        {
            title = innerProps.event.extendedProps.employee_fname + ' ' + innerProps.event.extendedProps.employee_lname;
        }

        return (createElement(Fragment, null,
            createElement("div", { className: "fc-row", style: { backgroundColor: innerProps.backgroundColor ? innerProps.backgroundColor : "#3788d8",color: innerProps.event.extendedProps.font_color ? innerProps.event.extendedProps.font_color : "white" } },
            createElement("div", { className: "fc-daygrid-event-dot", style: { borderColor: "white" /*innerProps.borderColor || innerProps.backgroundColor*/ } }),
            innerProps.timeText && (createElement("div", { className: "fc-event-time" }, innerProps.timeText + " " + title))),
