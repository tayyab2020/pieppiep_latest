@extends((Route::currentRouteName() == "default-features-edit" || Route::currentRouteName() == "default-features-create" || Route::currentRouteName() == "admin-feature-update-request") ? 'layouts.admin' : 'layouts.handyman')
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    ...
                                    <div class="add-product-header">
                                        <h2>{{isset($feature) ? (Route::currentRouteName() == "default-features-edit" ? 'Edit Feature' : 'Feature Update Request') : 'Add Feature'}}</h2>
                                        <a href="{{Route::currentRouteName() == 'default-features-edit' || Route::currentRouteName() == 'default-features-create' ? route('default-features-index') : (Route::currentRouteName() == 'admin-feature-update-request' ? route('admin-features-update-requests') : route('features-update-requests'))}}" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a>
                                    </div>

                                    <form class="form-horizontal" action="{{Route::currentRouteName() == 'admin-feature-update-request' ? route('admin-feature-update-request-post') : (Route::currentRouteName() == 'feature-update-request' ? route('feature-update-request-post') : route('default-features-store'))}}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <table style="margin: auto;">
                                                                    ...
                                                                    @foreach($features_data as $f1 => $key1)
                                                                        ...
                                                                        <tr data-id="{{$f1+1}}">
                                                                            <td>
                                                                                ...
                                                                                <input value="{{Route::currentRouteName() == 'default-features-edit' ? $key1->id : $key1->row_id}}" type="hidden" name="feature_ids[]">
                                                                            ...
                                                                            <td>
                                                                                <input value="{{$key1->factor_value}}" class="form-control factor_value" name="factor_values[]" id="blood_group_slug" placeholder="Factor" type="text">
                                                                            </td>
                                                                            <td>
                                                                            ...
                                                                            <td style="text-align: center;">
                                                                                ...
                                                                                <span data-id="{{Route::currentRouteName() == 'default-features-edit' ? $key1->id : $key1->row_id}}" id="next-row-span" class="tooltip1 remove-row" style="cursor: pointer;font-size: 20px;margin-left: 10px;">
                                                                ...
                                                                @else
                                                                    ...
                                                                    <tr data-id="1">
                                                                        ...
                                                                        <td>
                                                                            <input class="form-control factor_value" name="factor_values[]" id="blood_group_slug" placeholder="Factor" type="text">
                                                                        </td>
                                                                        <td>
                                        ...
                                        @if(Route::currentRouteName() != "feature-update-request")

                                            <div style="margin-top: 20px;" class="add-product-footer">
                                                <button name="addProduct_btn" type="submit" class="btn add-product_btn">{{isset($feature) ? (Route::currentRouteName() == "default-features-edit" ? 'Edit Feature' : (Route::currentRouteName() == 'admin-feature-update-request' ? 'Approve Request' : 'Edit Feature Update Request')) : 'Add Feature'}}</button>
                                            </div>
                                                                            ...
                                                                            <table style="margin: auto;width: 95%;border-collapse: separate;">
                                                                                        ...
                                                                                        @if($key->id == $key1->main_id)
                                                                                            ...
                                                                                            <tr data-id="1">
                                                                                                <td>
                                                                                                    ...
                                                                                                    <input type="hidden" name="feature_row_ids{{$s+1}}[]" value="{{Route::currentRouteName() == 'default-features-edit' ? $key1->id : $key1->row_id}}">
                                                                                                ...
                                                                                                <td>
                                                                                                    <input value="{{$key1->factor_value}}" class="form-control factor_value1" name="factor_values{{$s+1}}[]" id="blood_group_slug" placeholder="Factor" type="text">
                                                                                                </td>
                                                                                                <td>
                                                                                                ...
                                                                                                <td>
                                                                                                    <div style="display: flex;justify-content: center;"><span data-id="{{Route::currentRouteName() == 'default-features-edit' ? $key1->id : $key1->row_id}}" class="ui-close remove-sub-feature" style="margin:0;position: relative;left: 0;right: 0;top: 0;">X</span></div>
                                                                                                </td>
                                                                                            </tr>
                                                                                ...
                                                                                @else
                                                                                    ...
                                                                                    <tr data-id="{{$s1}}">
                                                                                        ...
                                                                                        <td>
                                                                                            <input value="" class="form-control factor_value1" name="factor_values{{$s+1}}[]" id="blood_group_slug" placeholder="Factor" type="text">
                                                                                        </td>
                                                                                        <td>
                                                                                            <select class="form-control" name="price_impact{{$s+1}}[]">
                                                                ...
                                                                <div data-id="1" class="sub-feature-table-container table">
                                                                    ...
                                                                    <table style="margin: auto;width: 95%;border-collapse: separate;">
                                                                        ...
                                                                        <tr data-id="1">
                                                                            ...
                                                                            <td>
                                                                                <input class="form-control factor_value1" name="factor_values1[]" id="blood_group_slug" placeholder="Factor" type="text">
                                                                            </td>
                                                                            <td>
...
<script type="text/javascript">
    ...
    $(document).on('click', "#add-sub-feature-btn", function(e){
        ...
        $('#sub-features').find(".sub-feature-table-container[data-id='" + id + "']").find('table').append('<tr data-id="'+feature_row+'">\n' +
            ...
            '                                                                                        </td>\n' +
            '                                                                                        <td>\n' +
            '                                                                                            <input class="form-control factor_value1" name="factor_values'+id+'[]" id="blood_group_slug" placeholder="Factor" type="text">\n' +
            '                                                                                        </td>\n' +
            '                                                                                        <td>\n' +
    ...
    $('body').on('click', '.remove-sub-feature' ,function() {
        ...
        if($('#sub-features').find(".sub-feature-table-container[data-id='" + heading_id + "']").find("table tbody tr").length == 0)
        {
            ...
            $('#sub-features').find(".sub-feature-table-container[data-id='" + heading_id + "']").find('table').append('<tr data-id="'+f_row+'">\n' +
                ...
                '                                                                                        </td>\n' +
                '                                                                                        <td>\n' +
                '                                                                                            <input class="form-control factor_value1" name="factor_values'+heading_id+'[]" id="blood_group_slug" placeholder="Factor" type="text">\n' +
                '                                                                                        </td>\n' +
                '                                                                                        <td>\n' +
    ...
    $(document).on('click', '.add-row', function () {
        ...
        $('#sub-features').append('<div data-id="'+feature_row+'" class="sub-feature-table-container table">\n' +
            ...
            '                                                                                        </td>\n' +
            '                                                                                        <td>\n' +
            '                                                                                            <input class="form-control factor_value1" name="factor_values'+feature_row+'[]" id="blood_group_slug" placeholder="Factor" type="text">\n' +
            '                                                                                        </td>\n' +
            '                                                                                        <td>\n' +
    ...
    $(document).on('click', '.remove-row', function () {
        ...
        if($('.options-table').find("table tbody tr").length == 0)
        {
            ...
            $('#sub-features').append('<div data-id="'+f_row+'" class="sub-feature-table-container table">\n' +
                ...
                '                                                                                        </td>\n' +
                '                                                                                        <td>\n' +
                '                                                                                            <input class="form-control factor_value1" name="factor_values'+f_row+'[]" id="blood_group_slug" placeholder="Factor" type="text">\n' +
                '                                                                                        </td>\n' +
                '                                                                                        <td>\n' +
