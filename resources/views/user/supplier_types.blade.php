                                                ...
                                                <select style="height: 100px;" class="form-control" name="supplier_types[]" id="supplier_types" multiple>
                                                    ...
                                                    @foreach($types as $cat)
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                $supplier_organization_ids = explode(',',$cat->other_suppliers_organizations);
                                                            }
                                                            else
                                                            {
                                                        ...
                                                        <option {{(in_array($organization_id, $supplier_organization_ids) ? 'selected' : null)}} value="{{$cat->type_id}}">{{$cat->type}}</option>
