...
{if 0.00 !== $product.unit_price_tax_included}
<p style="text-align: center;margin-top: 5px;" class="product-unit-price sub">&euro;{$product.unit_price_tax_included|number_format:2} {$product.unity}</p>
{/if}
