                                    ...
                                    <form id="product_form" style="padding: 0;" class="form-horizontal" action="{{$admin ? route('all-product-store') : route('admin-product-store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="add-product-box">
                                            <div class="add-product-header">
                                                ...
                                                <div style="display: flex;align-items: center;justify-content: center;" class="col-sm-6">
                                                    <label style="margin: 0;" class="control-label" for="blood_group_display_name">{{__('text.Title')}}</label>
                                                    <div class="col-sm-8">
                                                    ...
                                                    <div id="menu5" class="tab-pane fade">
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 20px;">
                                                            ...
                                                            <div class="row" style="margin: 0;text-align: center;">
                                                                <button type="button" class="btn btn-success" id="add-feature-btn">{{__("text.Add More Heading")}}</button>
                                                            </div>
    
                                                            <div class="row feature_box" style="margin: 0;display: flex;flex-wrap: wrap;">
                                                                ...
                                                                @foreach($features_headings as $h => $heading)
                                                                    ...
                                                                    @if((isset($features_data) && count($features_data) > 0) && ($features_data->contains('heading_id', $heading->id)))
                                                                        ...
                                                                        <div data-id="{{$h+1}}" class="feature-row col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                                            ...
                                                                            <i data-id="{{$h+1}}" class="fa fa-pencil create-feature-btn"></i>
                                                                            <i data-id="{{$h+1}}" class="fa fa-close remove-feature"></i>
                                                                            
                                                                            @foreach($features_data as $f => $key)
    
                                                                                @if($key->heading_id == $heading->id)
    
                                                                                    <div data-id="{{$f+1}}" class="feature-group">
                                                                                        <input value="{{$key->status}}" name="features_status[]" type="hidden" class="feature_status">
                                                                                        <input {{$key->status ? "checked" : null}} type="checkbox" class="features_titles" id="features_titles{{$f+1}}">
                                                                                        <label for="features_titles{{$f+1}}">{{$key->title}}</label>
                                                                                    </div>
                                                                                        ...
                                                                                        <div data-id="{{$s+1}}" class="sub-feature-table-container">
                                                                                            ...
                                                                                            <table style="margin: auto;width: 95%;border-collapse: separate;">
                                                                                                ...
                                                                                                @if($sub_features_data->contains('main_id',$key->id))
                                                                                                    ...
                                                                                                    @foreach($sub_features_data as $sd => $key1)
                                                                        ...
                                                                        <div data-id="{{$m+1}}" class="form-group model-row" style="margin: 0 0 20px 0;">
                                                                            ...
                                                                            <div style="display: flex;align-items: center;height: 40px;justify-content: center;" class="col-sm-3">
                                                                                ...
                                                                                <select class="form-control" id="model_measure" name="model_measure[]">
                                                                                    <option {{$key->measure == 'M1' ? 'selected' : null}} value="M1">m¹</option>
                                                                                    <option {{$key->measure == 'M2' ? 'selected' : null}} value="M2">m²</option>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('body').on('change', '.size-checkbox' ,function(){
            ...
            if($(this).is(":checked"))
            {
                add_model(size_id,title,measure);
        ...
        function fetch_features(data)
        {
            $('.feature_box').find(".feature-row").find('.remove-feature').each(function() {
                ...
                var id = $(this).data('id');
                var row_id = $(this).parents(".feature-row").data('id');
            ...
            if(data.length == 0)
            {
                $(".feature_box").append('<div data-id="1" class="feature-row col-lg-3 col-md-3 col-sm-4 col-xs-6">\n' +
                '\n' +
                '                                                                            <select class="form-control validate js-data-example-ajax5">\n' +
                '\n' +
                '                                                                                <option value="">{{__("text.Select Feature Heading")}}</option>\n' +
                ...
                '                                                                            </select>\n' +
                '\n' +
                '                                                                            <i data-id="1" class="fa fa-pencil create-feature-btn"></i>\n' +
                '                                                                            <i data-id="" class="fa fa-close remove-feature"></i>\n' +
                '\n' +
                '</div>');
            ...
            $.each(data, function(index, value) {
                ...
                $(".feature_box").append('<div data-id="' + heading_row + '" class="feature-row col-lg-3 col-md-3 col-sm-4 col-xs-6">\n' +
                '\n' +
                '                                                                            <select class="form-control validate js-data-example-ajax5">\n' +
                '\n' +
                '                                                                                <option value="">{{__("text.Select Feature Heading")}}</option>\n' +
                ...
                '                                                                            </select>\n' +
                '\n' +
                '                                                                            <i data-id="' + heading_row + '" class="fa fa-pencil create-feature-btn"></i>\n' +
                '                                                                            <i data-id="" class="fa fa-close remove-feature"></i>\n' +
                '\n' +
                '</div>');
        ...
        function add_model(size_id = '',title = '',measure = '')
        {
            ...
            $(".model_box").append('<div data-id="'+model_row+'" class="form-group model-row" style="margin: 0 0 20px 0;">\n' +
                ...
                '                                                                        <select class="form-control" id="model_measure" name="model_measure[]">\n' +
                '\n' +
                (measure == 'M1' ? '<option selected value="M1">m¹</option>\n' : '<option value="M1">m¹</option>\n') +
                (measure == 'M2' ? '<option selected value="M2">m²</option>\n' : '<option value="M2">m²</option>\n') +
        ...
        var $selects = $('body').on('change', '.js-data-example-ajax5', function()
        {
            ...
            if (heading_id && ($('.js-data-example-ajax5').find('option[value=' + heading_id + ']:selected').length > 1)) {
        ...
        $('body').on('change', '.features_titles', function() {
            var checked = $(this).is(':checked') ? 1 : 0;
            $(this).parents(".feature-group").find(".feature_status").val(checked);
        });
        ...
        function label_update(selector,main = null,id = null,title = null)
        {
            ...
            if(title)
            {
                var length = $('.feature_box').find(".feature-row[data-id='" + main + "']").find(".feature-group[data-id='" + id + "']").length;

                if(length)
                {
                    $('.feature_box').find(".feature-row[data-id='" + main + "']").find(".feature-group[data-id='" + id + "'] label").text(title);
                }
                else
                {
                    $('.feature_box').find(".feature-row[data-id='" + main + "']").append('<div data-id="'+id+'" class="feature-group"><input value="0" name="features_status[]" type="hidden" class="feature_status"><input type="checkbox" class="features_titles" id="features_titles'+id+'"><label for="features_titles'+id+'">'+title+'</label></div>');
                }
            }
        ...
        $("#add-feature-btn").on('click',function() {
            ...
            $(".feature_box").append('<div data-id="' + heading_row + '" class="feature-row col-lg-3 col-md-3 col-sm-4 col-xs-6">\n' +
                ...
                '\n' +
                '                                                                            <i data-id="' + heading_row + '" class="fa fa-pencil create-feature-btn"></i>\n' +
                '                                                                            <i data-id="' + heading_row + '" class="fa fa-close remove-feature"></i>\n' +
                '\n' +
                '</div>');
        ...
        $('body').on('click', '.remove-primary-feature' ,function() {
            ...
            $('.feature_box').find(".feature-row[data-id='" + heading_id + "']").find(".feature-group[data-id='" + row_id + "']").remove();
        ...
        $('body').on('click', '.remove-feature' ,function() {
            ...
            if($(".feature_box .feature-row").length == 0)
            {
                $(".feature_box").append('<div data-id="1" class="feature-row col-lg-3 col-md-3 col-sm-4 col-xs-6">\n' +
                '\n' +
                '                                                                            <select class="form-control validate js-data-example-ajax5">\n' +
...
<style type="text/css">
    ...
    .feature-row .select2-selection
    {
        border: 0 !important;
    }

    .feature-row .select2-selection__rendered
    {
        font-weight: 700;
        padding: 0 !important;
    }

    .feature-row .select2-container
    {
        max-width: 80%;
    }
    ...
    .feature-group input:checked + label:after {
        content: '';
        display: block;
        position: absolute;
        top: 7px;
