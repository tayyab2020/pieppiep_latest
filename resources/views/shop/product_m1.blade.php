...
<body>
                    ...
                    <div id="calculationRows">
                        <div class="calculation-row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="model[]" class="form-control model-select">
                                    @foreach($product->models as $model)
                                        <option value="{{ $model->id }}" data-measure="{{ strtolower($model->measure) }}" data-price="{{ $model->estimated_price_per_box }}" data-quantity="{{ $model->estimated_price_quantity }}" data-max-width="{{ $model->max_width }}">{{ $model->model }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group width-group">
                                ...
                                <input type="number" name="width[]" class="form-control width-input" required>
                            </div>

                            <div class="form-group height-group">
                                <label for="height">Enter Height (cm)</label>
                                <input type="number" name="height[]" class="form-control height-input" required>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#priceCalculator').on('input', '.width-input, .height-input, .model-select', function() {
                calculateTotalPrice();
            });
