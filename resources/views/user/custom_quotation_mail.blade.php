...
@elseif($type == 'new-invoice')

    <p>
        Hi {{$client}},<br><br>Recent activity: A new invoice <b>({{$order_number}})</b> has been generated by <b>{{$company_name}}</b><br>Quotation No: {{$quotation_number}}. PDF file is attached below.<br><br>Kind regards,<br><br>Klantenservice<br><br> Pieppiep
    </p>
